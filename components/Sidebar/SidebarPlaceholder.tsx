...
export default function SidebarPlaceholder({ onRouteChange, currentRoute }: SidebarPlaceholderProps) {
  ...
  const menuItems = [
    ...
    { id: 'signup' as Route, label: 'Sign Up', icon: '✍️' },
  ];

  return (
    <div className="w-64 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white h-full flex flex-col transition-colors duration-200">
      {/* Logo/Header */}
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-800">
        <button
          onClick={toggleTheme}
          className="w-full flex items-center justify-center space-x-2 px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors"
